...
namespace Ldap
{
	...
	public:
		...
		std::vector<std::string> GetStringValues(const std::string&) const;
		std::list<std::string> GetStringList(const std::string&) const;

		std::vector<char> GetBinaryValue(const std::string&) const;
		std::vector< std::vector<char> > GetBinaryValues(const std::string&) const;
		std::list< std::vector<char> > GetBinaryList(const std::string&) const;
